        ...
        <form onSubmit={handleSubmit} className="w-full">
          ...
          <div className="flex flex-wrap gap-6">
            <label className="flex flex-col w-[48%]">
              Username
              <input
                className="bg-transparent border-b border-black outline-none p-2"
                type="text"
                name="username"
          ...
          <div className="flex justify-center mt-10">
            <button
              type="submit"
              className="bg-blue-500 text-white py-2 px-8 rounded-full shadow hover:bg-blue-600 transition duration-300 ease-in-out"
            >
              Sign Up
            </button>
          </div>
