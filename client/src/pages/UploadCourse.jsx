...
const UploadCourse = () => {
  ...
  const upload = () => {
    ...
    axios
      .post(`${import.meta.env.VITE_BACKEND_URL}/upload/create`, formData)
      .then((res) => {
        ...
        <div className="flex flex-col gap-5">
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              className=" text-sm w-96 p-2 rounded border border-solid border-[#c5c5c5]"
              type="text"
              name="title"
          ...
          <div className="flex flex-col gap-2">
            ...
            <input
              placeholder="Insert course subtitles"
              type="text"
              name="tags"
              className=" text-sm w-96 p-2 rounded border border-solid border-[#c5c5c5]"
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex gap-10 justify-center items-center">
              <img
                src={imageFileUrl}
                alt="Selected File"
                className="mb-2 w-56 border border-solid border-black"
              />
              <div>
                ...
                <div className="flex gap-5 border-black">
                  <label
                    htmlFor="fileInput"
                    className="cursor-pointer p-2 border border-solid border-black font-bold hover:bg-[#f0f0f0] transition-all"
                  >
                    Upload File
                    <input
                      type="file"
